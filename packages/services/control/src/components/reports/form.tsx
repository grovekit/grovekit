...
import { NULL_REPORT_ID, ReportOpts, ReportParams, ReportSeriesOpts, SERIES_STYLES } from "./types.js";
...
export const ReportForm: FC<{ params: ReportParams, curr_url: URL | string, report_id: string }> = (props) => {
  const { params: { opts, series }, curr_url, report_id } = props;
